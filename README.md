...
<p align="left">
  Karabük Üniversitesi Matematik Bölümü mezunuyum.Ve bir matematikçi olarak "Front end developer" alanında çalışmaktayım.Front end teknolojilerini sırası ile html , css ,scss,bootstrap , javascript , React.js ve next.js öğrendim ve projelerimde bu teknolojileri kullanmaktayım.Son olarak javascript freameworklerinden angular tarafında eğitimler alarak kendimi bu alanda da geliştirmekteyim.Anguları hem farklı freameworklerle çalışabilen bir frontend developer olma konusunda hemde typescript mantıgını kavrayıp kullanabilmem konusunda bana destek olabilmesi için tercih ettim.
</p>
